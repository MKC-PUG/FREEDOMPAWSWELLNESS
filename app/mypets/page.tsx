    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-950 via-black to-red-950 text-white p-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300">Your Tokenized Dynamic NFT Protocols</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {protocols.map((protocol, index) => (
            <div key={index} className="bg-white/10 backdrop-blur-xl rounded-3xl overflow-hidden border border-white/20 hover:border-yellow-400 transition-all group">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-400 mb-6">{protocol.description}</p>
                <button className="w-full bg-yellow-400 hover:bg-yellow-300 text-black font-bold py-4 rounded-2xl transition">
                  View / Update Record →
                </button>
              </div>
            </div>

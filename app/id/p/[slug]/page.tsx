...
export default async function PublicPetCardPage({ params }: Props) {
  ...
  return (
    <PageShell maxWidth="lg" innerClassName="flex flex-col items-center">
      <SectionCard padding="lg" className="max-w-md w-full text-center border-2 border-emerald-500/40 bg-gradient-to-b from-[#1F2A44] to-[#0A1625] shadow-xl">
